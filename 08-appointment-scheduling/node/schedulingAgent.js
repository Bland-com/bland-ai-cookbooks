/**
 * Bland AI Cookbook - Appointment Scheduling Agent (Node.js)
 *
...
const CALENDAR_SERVER_URL =
  process.env.CALENDAR_SERVER_URL || "http://localhost:5100";
...
const CALENDAR_AUTH_KEY =
  process.env.CALENDAR_AUTH_KEY || "test-calendar-key";
...
if (CALENDAR_SERVER_URL === "http://localhost:5100") {
  console.warn("Warning: CALENDAR_SERVER_URL is set to localhost.");
  console.warn("Bland's servers cannot reach localhost. Use ngrok to create a");
  console.warn("public URL and set CALENDAR_SERVER_URL in your .env file.");
  console.warn();
}
...
const AGENT_TASK = `You are Emma, a friendly and professional receptionist at Bright Smile Dental,
...
const checkAvailabilityTool = {
  ...
  url: `${CALENDAR_SERVER_URL}/api/availability`,
  ...
  headers: {
    ...
    Authorization: `Bearer ${CALENDAR_AUTH_KEY}`,
  },
  ...
  input_schema: {
    ...
    properties: {
      ...
      service: {
        type: "string",
        description:
          "The type of service requested (cleaning, whitening, exam, filling, or crown consultation)",
      },
    },
  },
...
const bookAppointmentTool = {
  ...
  description:
    "Book an appointment for the caller at a specific date, time, and service",

  // The booking endpoint on your calendar server.
  url: `${CALENDAR_SERVER_URL}/api/book`,
  ...
  input_schema: {
    ...
    properties: {
      ...
      service: {
        type: "string",
        description:
          "Service type (cleaning, whitening, exam, filling, or crown consultation)",
      },
      customer_name: {
        type: "string",
...
// This object contains all the parameters for the Bland API call.
...
const payload = {
  ...
  // Each tool is an object with name, description, url, method, headers,
  ...
  first_sentence:
    "Hi there! Thank you for calling Bright Smile Dental. This is Emma. How can I help you today?",
  ...
  voicemail: {
    ...
    message:
      "Hi, this is Emma from Bright Smile Dental. We were calling to help you schedule an appointment. Please call us back at (555) 234-5678 at your convenience. Thank you and have a great day!",
  },
};
...
async function sendCall() {
  ...
  console.log(`Sending scheduling call to ${PHONE_NUMBER}...`);
  console.log(`Calendar server: ${CALENDAR_SERVER_URL}`);
  console.log("Tools attached: check_availability, book_appointment");
  console.log();
  ...
  try {
    ...
    if (data.status === "success") {
      ...
      console.log();
      console.log(
        "Your phone should ring shortly. Answer it and try booking an appointment."
      );
      console.log();
      console.log(
        "Watch your calendar server terminal to see tool requests come in."
      );
      console.log();
      console.log("To retrieve call details after it ends, run:");
      console.log(
        `  curl -X GET https://api.bland.ai/v1/calls/${callId} \\`
      );
      console.log(`    -H 'Authorization: ${API_KEY}'`);
    } else {
